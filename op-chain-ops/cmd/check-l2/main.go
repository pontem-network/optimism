...
import (
	...
	"github.com/ethereum-optimism/optimism/op-chain-ops/contracts"
...
func getEIP1967AdminAddress(client *ethclient.Client, addr common.Address) (common.Address, error) {
	slot, err := client.StorageAt(context.Background(), addr, contracts.EIP1967AdminSlot, nil)
	if err != nil {
...
func getEIP1967ImplementationAddress(client *ethclient.Client, addr common.Address) (common.Address, error) {
	slot, err := client.StorageAt(context.Background(), addr, contracts.EIP1967ImplementationSlot, nil)
	if err != nil {
		return common.Address{}, err
	}
